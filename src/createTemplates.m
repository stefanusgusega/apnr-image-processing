...
one = imread(fullfile(templateDir, '1.bmp')); one2 = imread(fullfile(templateDir, '12.bmp')); two = imread(fullfile(templateDir, '2.bmp'));
...
number = [one one2 two three four five six seven eight nine zero zero2];
